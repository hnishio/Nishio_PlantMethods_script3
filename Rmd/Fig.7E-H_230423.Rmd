...
{void +
{(g5[[1]] + labs(tag = "E")) + g5[[2]] + g5[[3]] + g5[[4]] + (g7[[1]] + labs(tag = "G")) + g7[[2]] + g7[[3]] + g7[[4]] + plot_layout(ncol = 1)} +
void +
{(g6[[1]] + labs(tag = "F")) + g6[[2]] + g6[[3]] + g6[[4]] + (g8[[1]] + labs(tag = "H")) + g8[[2]] + g8[[3]] + g8[[4]] + plot_layout(ncol = 1)} + 
void + 
